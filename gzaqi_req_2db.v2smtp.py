...
try:
    ...
    for c in b:
        try:
            ...
            msg = MIMEText(str(e.args)+'\n'+str(c))
            msg['Subject']='gzaqi erro'
            msg['From']="hgf's raspberrypi"
            msg['to'] = 'hgfly@icloud.com'

            sm=smtplib.SMTP_SSL(host='smtp.qq.com')
            sm.connect('smtp.qq.com')
            sm.login('csuhgf@qq.com', 'bbeznlpmotgcdiff')
            sm.sendmail('csuhgf<csuhgf@qq.com>', 'hgfly@icloud.com', msg.as_string())
            sm.close()	
